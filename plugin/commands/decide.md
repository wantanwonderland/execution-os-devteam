Log a decision to the vault. Create a structured decision record in `04-decisions/log/`.
...
2. Create the file in `04-decisions/log/` with this structure:
...
## Goal Alignment
[Which active goal(s) this serves — check 05-goals/active/ if needed]

## Revenue Impact
[Direct / indirect / none — and brief explanation]
```

4. **Apply decision filters**: Reference `00-identity/values/decision-filters.md` and briefly note which of the 5 filters this decision passes. If any filter is unclear, flag it.
