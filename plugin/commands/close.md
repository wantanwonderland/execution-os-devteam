...
**Pulse metrics**: If a pulse file exists for the current week (`06-ceremonies/pulse-YYYY-WNN.md`), increment these counters:
...
- New architectural decisions or ADRs → ensure filed in `02-docs/adrs/`
