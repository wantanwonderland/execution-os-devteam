Project scaffolding wizard. Dispatches Tanjiro to create a new project.
...
2. **Dispatch Tanjiro**: Send to Tanjiro with the `project-scaffold` skill. Provide: project type, user's answers to wizard questions.

3. **Scaffold**: Tanjiro creates the project directory structure, configuration files, and starter code.

4. **Verify**: Tanjiro runs: install deps → build → test → dev server start. All must pass.
