...
1. **Sprint summary**: Dispatch Erwin to compile:
...
5. **Write sprint review**: Create `06-ceremonies/sprint-review/YYYY-MM-DD-sprint-{id}-review.md` with all metrics, goal status, and highlights.
