...
2. **Route to destination** using CLAUDE.md auto-sort rules:
   - Project-specific work → `01-projects/{project}/`
   - Research task → `03-research/`
   - Goal-related task → update existing file in `05-goals/active/`
   - General/unclear → `08-inbox/captures/`
