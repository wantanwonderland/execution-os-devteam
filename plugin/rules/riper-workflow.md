...
1. Dispatch Hange for background research (tech evaluation, alternatives)
...
Implement the plan:
1. Dispatch agents per the plan (Levi for reviews, Killua for tests, etc.)
...
3. Dispatch Levi for code review of changes
