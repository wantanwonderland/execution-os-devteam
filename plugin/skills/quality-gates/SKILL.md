...
- **Levi**: Must include `pr_number` or `file:line` references
...
- **Erwin**: Must include sprint_id and velocity numbers
...
Erwin: completion_rate == completed / committed (within 1% tolerance)
```
