...
| Signal | File | Action |
|--------|------|--------|
| Standup update | `06-ceremonies/standup/YYYY-MM-DD.md` | Create or update today's standup log |
| Sprint goal progress | `06-ceremonies/sprint-review/current-sprint.md` | Update goal completion status |
| Blocker surfaced | `06-ceremonies/standup/issues-list.md` | Add to active blockers list |
| Retro action item | `06-ceremonies/retro/YYYY-MM-DD-retro.md` | Log as action item with owner |
| Decision made in ceremony | `04-decisions/log/YYYY-MM-DD-decision.md` | Log decision record |
