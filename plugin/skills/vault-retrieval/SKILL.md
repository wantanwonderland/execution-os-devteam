...
2. **Historical pattern** ("how have we...", "track record", "past decisions on..."): Query wantan-mem for cross-session context first. Supplement with local `vault/04-decisions/log/` grep.
