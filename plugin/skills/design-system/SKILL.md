---
name: design-system
description: Rohan's design system skill. Design tokens, OKLCH theming, component library patterns, typography scales. Reverse-engineered from wilwaldon's Frontend Design Toolkit.
---
