---
name: react-patterns
description: Tanjiro's React component patterns skill. Component architecture, state management, performance, hooks, and testing patterns. Reverse-engineered from jezweb and shinpr.
---
