...
When {{OWNER_NAME}} expresses a decision, log it to `vault/04-decisions/log/` without being asked.
...
Create file at `vault/04-decisions/log/YYYY-MM-DD-decision-short-name.md`:
...
- Check alignment against `vault/05-goals/active/` goals and note any connections in `related`
