...
- Captures land in `08-inbox/captures/` first, then get sorted
- Decisions always go to `04-decisions/log/` with date prefix
- Sprint reviews go to `06-ceremonies/sprint-review/` with date prefix
- Retros go to `06-ceremonies/retro/` with date prefix
