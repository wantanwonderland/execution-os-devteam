...
2. Search `09-ops/incidents/` for related incidents
3. Search `02-docs/runbooks/` for existing runbooks on similar topics
...
Save to `02-docs/runbooks/{topic-slug}-runbook.md`
