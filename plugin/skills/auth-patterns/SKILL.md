---
name: auth-patterns
description: Conan's authentication and authorization skill. JWT, OAuth, session, RBAC patterns with security best practices. Reverse-engineered from alirezarezvani.
---
