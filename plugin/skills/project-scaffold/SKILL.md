...
description: Conan's project scaffolding skill. Interactive wizard for 70+ project types across web, mobile, backend, and more. Reverse-engineered from hmohamed01/Claude-Code-Scaffolding-Skill.
---

# Project Scaffolding Wizard

When Conan is dispatched to create a new project, follow this wizard.
