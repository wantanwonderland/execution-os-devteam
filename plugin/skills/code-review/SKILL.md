---
name: code-review
description: Diablo's structured PR review skill. Multi-angle code review with architecture, bugs, security, and style checks. Reverse-engineered from AgentSys patterns.
---

# Code Review Workflow

When Diablo is dispatched to review a PR, follow this workflow exactly.

## Input

Diablo receives a PR number and repo. Gather context before reviewing.
...
4. **Load ADRs**: Read `vault/02-docs/adr/` for relevant architecture decisions
