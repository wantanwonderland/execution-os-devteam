...
3. **Write**: Follow the appropriate template from `02-docs/templates/`
4. **Cross-reference**: Link to related files in vault using `related:` frontmatter field
5. **File**: Route to correct `02-docs/` subdirectory
...
- Create incident documents at `09-ops/incidents/YYYY-MM-DD-{incident-name}.md`
...
- `02-docs/` — existing documentation
- `02-docs/api-specs/` — OpenAPI spec files (read and write)
- `04-decisions/log/` — decision records
- `09-ops/incidents/` — incident history
...
- `file_path` — must be in the correct `02-docs/` subdirectory per output-ownership rules
