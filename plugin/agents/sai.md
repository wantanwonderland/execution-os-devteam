...
- Build and maintain `dashboard/index.html` (Dev Team Performance Hub)
- Create new dashboard views as needed
- Read data from `data/company.db` via sql.js (CDN)
...
- `data/company.db` — all tables (read-only via sql.js)
- Dashboard files in `dashboard/`

## Output Format

- Dashboard updates: `dashboard/index.html` and related files
- Standalone reports: `09-ops/dashboards/`
