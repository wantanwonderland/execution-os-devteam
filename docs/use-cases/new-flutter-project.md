...
**Ochaco** creates Material 3 theme:
...
```
Tell Tanjiro to build a habit tracking feature:
...
| Task | Agent(s) | How |
|------|---------|-----|
| Scaffold Flutter project | Tanjiro | `/new flutter` |
| Material 3 theming | Ochaco | `/design` |
| Feature development | Tanjiro | natural language request |
