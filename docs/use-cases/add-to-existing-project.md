...
```
# Have Diablo review a PR
Tell Diablo to review PR #42
...
Tell Conan to add a user settings page with email change, password change, and notification preferences
```
...
| Sprint progress, velocity | Kazuma |
| Research, tech evaluation | Wiz |
| Architecture, tech debt | Senku |
| UI design, aesthetics | Rohan |
| Project scaffolding, full-stack dev | Conan |
