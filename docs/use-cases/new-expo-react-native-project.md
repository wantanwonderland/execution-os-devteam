...
Ochaco creates the component using NativeWind classes with all states.
...
```
Tell Tanjiro to set up the app navigation:
...
Tanjiro creates the Expo Router file structure:
...
```
Tell Tanjiro to build the restaurant listing feature:
...
| Task | Agent(s) | How |
|------|---------|-----|
| Scaffold Expo project | Tanjiro | `/new expo` |
| App design + theming | Ochaco | `/design` |
| Navigation structure | Tanjiro | natural language request |
| API integration | Tanjiro | natural language request |
| Component development | Tanjiro + Ochaco | natural language + `/design component` |
