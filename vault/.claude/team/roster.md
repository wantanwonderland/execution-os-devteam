...
| **Diablo** | Attack on Titan | Code Reviewer | Obsessively clean, exacting standards | PR review, code quality, architectural consistency | Opus | Active | `.claude/agents/diablo.md` |
...
| **Kazuma** | Attack on Titan | Sprint Tracker | Mission-driven, accountable | Sprint ceremonies, velocity, standup, retro | Sonnet | Active | `.claude/agents/kazuma.md` |
| **Wiz** | Attack on Titan | Content Researcher | Curious, thorough, synthesis-driven | Research, RFC prep, tech evaluations, meeting prep | Opus | Active | `.claude/agents/wiz.md` |
...
|------------|----------|-----|
| PR review, code quality, architectural consistency | Diablo | Owns code review workflow |
...
| Sprint progress, velocity, standup, retro, planning | Kazuma | Owns sprint data + ceremonies |
| Research, RFC prep, tech evaluation, meeting prep | Wiz | Vault + web deep research |
...
| Diablo | Opus | Read, Glob, Grep, Bash, WebFetch |
...
| Kazuma | Sonnet | Read, Write, Bash, Glob, Grep |
| Wiz | Opus | Read, Glob, Grep, WebSearch, WebFetch |
